 ...
 * Sport Icons Mapping
 *
 * Maps sport type strings to icon imports from src/assets/ui-icons/
 * Icons are bundled with the application during build.
 */
...
/**
 * Get icon URL for a sport type
 * @param {string} sportType - Sport type name (e.g., 'Basketball')
